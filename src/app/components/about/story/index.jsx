    ...
    return (
        <section className="bg-white text-[#232323] py-[3rem] sm:px-[10rem] px-[3rem] flex flex-col">
            ...
            <div className="mt-[3rem]">
                <h2 className="sub-header text-center">The Ace 8 <span className="text-[#624C83]">Domains</span></h2>
            ...
            <img src="/industries_sm.svg" className="hidden sm:block mt-[10rem]" alt="" />
        </section>
    );
}
