                ...
                <div className="sm:flex-[.8]">
                    <form action="" className="bg-white px-[2.3rem] py-[1.5rem] sm:py-[4rem] flex flex-col rounded-[1rem] mt-[3rem] sm:mt-[0]">
                        ...
                        <div className="flex items-start  py-[.8rem] gap-x-[1rem] border-b border-b-black mb-[3rem]">
                            <img src="/_message.svg" required className="mt-[.4rem]" alt="message" />
                        ...
                        <button disabled={name == '' || email == '' || message == ''} className="text-black btn disabled:opacity-[.5] self-end bg-[#8FD5CC]" onClick={handleSubmit}>{loading ? 'Loading...' : 'Submit'}</button>
                    </form>
                </div>
            </div>
        </section>
