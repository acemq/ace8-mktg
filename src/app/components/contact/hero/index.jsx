    ...
    return (
        <section className="sm:py-[5.5rem] py-[8rem] sm:pt-[17rem] sm:pb-[18rem] px-[1.5rem] sm:px-[10rem] relative">
            ...
            <div className="flex flex-col items-center relative">
               ...
               <p className="sm:w-[60rem] text-center">Let us know how we can add value to your organization and we'll connect you to one of our experts for a free consultation.</p>
            </div>
        </section>
    );
}
