    ...
    return (
        <section className="mt-[6rem] sm:mb-[10rem] pt-[2rem] sm:pt-[0] pb-[4rem] sm:pb-[0] px-[3rem] sm:px-[10rem] relative">
            ...
            <div className="relative">
                ...
                <div className="sm:pl-[5rem] sm:py-[3rem] z-[1]  rounded-[2rem] sm:pb-[5rem] sm:grid bg-banner-flare sm:place-content-center relative">
                    <img
                        src="/service_banner2.png"
                        className="w-[100%] rounded-[2rem] mix-blend-soft-light difference h-[100%] absolute inset-0 z-[0]  sm:block hidden" alt="background" />
