...
const SupportServices = () => {
    const services = [
        {
            title: <h3 className="text-[1.5rem] text-center font-[700]">24/7 Technical <span className="text-[#9B86FE]">Support</span></h3>,
            description: "Access to our experts around the clock",
            icon: "/support.svg",
        },
        {
            title: <h3 className="text-[1.5rem] text-center font-[700]"><span className="text-[#FF88C3]">Installation</span> and Configuration</h3>,
            description: "Optimize your Tomcat setup for peak Performance",
            icon: "/installation.svg",
        },
        {
            title: <h3 className="text-[1.5rem] text-center font-[700]">Emergency <span className="text-[#5747A5]">Hot Fixes</span></h3>,
            description: "Rapid solutions for critical issues.",
            icon: "/Hot-fixes.svg",
        },
        {
            title: <h3 className="text-[1.5rem] text-center font-[700]">Security <span className="text-[#8FD5CC]">Vulnerability</span> Notifications</h3>,
            description: "Expert support services for integrating Apache Tomcat with other technologies.",
            icon: "/vulnerability.svg",
        },
        {
            title: <h3 className="text-[1.5rem] text-center font-[700]">Compliance <span className="text-[#5747A5]">Assistance</span></h3>,
    ...
    return (
        <section className="py-[8rem] bg-[#0D1117]">
            <p className="max-w-[110rem] text-center mx-auto"><span className="text-[#9B86FE]">Apache Tomcat</span> is a cornerstone for deploying and managing Java-based applications. Whether on-premises or in the cloud, achieving optimal performance and reliability requires expertise. Our specialized Tomcat services ensure your deployments run smoothly, securely, and aligned with your business goals.</p>
            ...
            <div className="mt-[5rem] flex flex-col">
                ...
                <div className="max-w-[1200px] mt-[4rem] justify-items-center gap-y-[6rem] grid sm:grid-rows-2 sm:grid-cols-6 mx-auto">
                    {
