                ...
                <div className="px-[3rem] sm:px-[10rem] text-black">
                    ...
                    <div  data-animation-id='slideIn' className="sm:flex justify-between mt-[5rem] flex-row-reverse text-end sm:text-start">
                        <div className="border-b sm:w-[45rem]">
                            <h2 className="sub-header">Security as <span className="font-[400]">the</span> <span className="text-[#458D84]">Top Priority</span></h2>
                    ...
                    <div className="mt-[5rem] sm:flex flex-col mb-[10rem]">
                        <h3  data-animation-id='slideIn' className="sub-header self-center mb-[1rem] sm:text-center sm:w-[60rem]"><span className="font-[400]">Cultural</span> Transformation <span className="font-[400]">for</span> <span className="text-[#0FC1FF] sm:text-[#FF88C3]">Success</span></h3>
