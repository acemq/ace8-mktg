...
const Index = () => {
    ...
    return (
        <section className="py-[5.5rem] sm:pt-[12rem] flex flex-col  sm:pb-[10rem] px-[2rem] sm:px-[10rem] relative">
            ...
            <div className="flex flex-col items-center relative">
                ...
                <p  data-animation-id='slideIn' className="mt-[2rem]">Combine Strength, Deliver Securely, and Thrive</p>
            </div>
        </section>
    );
}
