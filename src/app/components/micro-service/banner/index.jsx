...
const Index = () => {
    return (
        <section className="mt-[6rem] sm:mt-[-20rem] sm:mb-[10rem] pt-[3rem] bg-black sm:bg-transparent sm:pt-[0] pb-[4rem] sm:pb-[0] px-[3rem] sm:px-[10rem] relative">
            <div data-animation-id='slideIn' style={{ backgroundSize: '100% 100%, 100% 100%, 100% 100%' }} className="sm:pl-[5rem] sm:py-[3rem] sm:pb-[5rem] bg-banner_hand bg-contain bg-no-repeat sm:grid sm:place-content-center  relative z-[2]">
                {/* <Image 
                    src={'/_border.png'}
                    width={1620}
                    height={574}
                    alt="border"
                    className="absolute inset-0 w-[100%] h-[100%] left-[1rem] z-[1] isolate top-[-2rem]"
                /> */}
