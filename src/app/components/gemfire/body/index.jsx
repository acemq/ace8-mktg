...
const Index = () => {
    const cards = [
        {
            header: <h2 className="text-[2.7rem] sm:text-[3.2rem] leading-[3.2rem] sm:leading-[4.2rem] my-[1rem] sm:my-[2rem] font-[700]  w-[20rem]"><span className="font-[400]">Unique</span> <span className="text-[#9B86FE]">Expertise</span></h2>,
            text: 'Benefit from the experience of two original GemFire developers, ensuring unparalleled insights into the platform',
            image: '/unique.svg'
        },
        {
            header: <h2 className="text-[2.7rem] sm:text-[3.2rem] leading-[3.2rem] sm:leading-[4.2rem] my-[1rem] font-[700] my-[2rem] w-[30rem]"><span className="font-[400]">Qualified Services</span> <span className="text-[#9B86FE]">Provider</span></h2>,
            text: 'We are a VMware Qualified GemFire Partner and are involved in GemFire Product Development',
            image: '/qualified.svg'
        },
        {
            header: <h2 className="text-[2.7rem] sm:text-[3.2rem] leading-[3.2rem] sm:leading-[4.2rem] my-[1rem] font-[700] my-[2rem] w-[30rem]"><span className="font-[400]">Comprehensive</span> <span className="text-[#9B86FE]"> Services</span></h2>,
        ...
        {
            header: <h2 className="text-[2.7rem] sm:text-[3.2rem] leading-[3.2rem] sm:leading-[4.2rem] my-[1rem] font-[700] my-[2rem] w-[20rem]"><span className="sm:font-[400]">Tailored</span> <span className="text-[#9B86FE]"> Solution</span></h2>,
            text: 'Receive personalized guidance and solutions tailored to your specific GemFire requirements and use cases.',
            image: '/tailored.svg'
        },
        {
            header: <h2 className="text-[2.7rem] sm:text-[3.2rem] leading-[3.2rem] sm:leading-[4.2rem] my-[1rem] font-[700] my-[2rem] w-[30rem]"><span className="font-[400]">Confidence and</span> <span className="text-[#9B86FE]"> Assurance</span></h2>,
        ...
        {
            header: <h2 className="text-[2.7rem] sm:text-[3.2rem] leading-[3.2rem] sm:leading-[4.2rem] my-[1rem] font-[700] my-[2rem] w-[30rem]"><span className="font-[400]">Proven Track</span> <span className="text-[#9B86FE]"> Record</span></h2>,
