...
const Index = () => {
  ...
  return (
    <section className="px-[3rem] md:px-[10rem] sm:mb-[0] mt-[3rem]">
      <h3 className="text-center text-[2.3rem] font-[700]">
        <span className="text-[#FF88C3]">Among</span> The Best
      </h3>
      <p className="text-center text-[1.2rem] sm:text-[1.8rem] mb-[3rem] sm:mb-[4rem]">
...
const Card = ({ card }) => (
  <div className="">
    <h4 className="text-center text-[1.5rem] mb-[1rem] sm:mb-[1.5rem] font-[700]">
      {card.header}
    </h4>
    <div className="relative sm:w-[60rem] h-[25.5rem] sm:h-[40rem]">
      <p className="text-center relative font-[700] text-[1.4rem] top-[1.5rem] z-[3]">
        customer story
      </p>
      <img
        className="absolute inset-0 top-0 h-[25rem] sm:h-auto bottom-0 z-[0]`"
        src={card.image}
        alt=""
      />
      ...
      <div className="absolute z-[3] bottom-[.7rem] sm:bottom-[2.5rem] w-[20rem] sm:w-[29rem] flex flex-col items-center mx-[17%] sm:mx-[25%]">
        ...
        <Link
          href={card.link}
          className="flex items-center font-[500] text-[1.2rem] mt-[2rem] gap-[1.5rem]"
        >
          Read Story{" "}
