        ...
        <section className="">
            <MaxContainer>
                <div className="px-[3rem] sm:px-[10rem]">
                    ...
                    <p className="text-center mt-[1.5rem] sm:w-[90rem] sm:mx-auto"> Are you tired of manually testing your e-commerce application, wasting valuable time and resources on tedious and repetitive tasks? Our automated testing service offers a unique approach that sets us apart from the competition.</p>
