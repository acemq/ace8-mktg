    ...
    return (
        <section className="py-[5.5rem] sm:pt-[15rem] sm:pb-[17rem] px-[1.5rem] sm:px-[10rem] relative">
            ...
            <div className="flex flex-col items-center relative">
                <h1 className="header text-center"><span className="text-[#9B86FE]">Comprehensive</span> <span className="font-[400]">Incident Management</span> for <span className="text-[#9B86FE]">Reliable</span> <span className="font-[400]">Operations</span></h1>
