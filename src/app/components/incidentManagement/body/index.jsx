        ...
        <section className="bg-white text-black">
            <MaxContainer>
                <div className="px-[3rem] sm:px-[10rem] relative py-[5rem]">
                    <h1 className="text-center hidden sm:block mx-auto sm:text-[5rem] sm:leading-[5.5rem] text-[3rem] leading-[4rem] font-[700] sm:w-[60rem]"><span className="text-[#5747A5]">Ace8</span> Incident <span className="font-[400]">Management</span> Plans</h1>
                    <div className="mb-[3rem] sm:mt-[5rem]  sm:flex flex-row-reverse justify-between">\
