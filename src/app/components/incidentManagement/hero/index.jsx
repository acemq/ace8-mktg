...
const Index = () => {
    ...
    return (
        <section className="">
            <MaxContainer>
                <div className="py-[5.5rem] pb-[3rem] pt-[10rem] sm:pt-[15rem] sm:pb-[17rem] px-[1.5rem] sm:px-[10rem] relative">
                    ...
                    <div  data-animation-id='slideIn' className="flex flex-col items-center relative">
                        ...
                        <p className="text-center text-[1.25rem] sm:text-[1.5rem] sm:w-[90rem] mt-[3rem] sm:mt-[0]">Trust our Unique Approach for Effective Incident Resolution</p>
                    </div>
                </div>
            </MaxContainer>
        </section>
